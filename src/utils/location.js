const location = [
  {
    ...
    description: [
      ...
      'First is either you want to enable high accuracy of not you can pass either true of false default is false',
      'Second parameter is timeout at which time you want function to return error if the location is not found default is 3seconds',
